...
//     const topCenterIndex: number = 0;
//     const bottomCenterIndex: number = 1;
//     const startIndex: number = 2;

//     // Side Vertices (top & bottom circles)
//     for (let i = 0; i < segments; i++) {
//       const angle: number = (i / segments) * Math.PI * 2;
//       const x: number = Math.cos(angle) * radius;
//       const z: number = Math.sin(angle) * radius;
//       const nx: number = Math.cos(angle);
//       const nz: number = Math.sin(angle);
//       const tangentX: number = -Math.sin(angle);
//       const tangentZ: number = Math.cos(angle);
...
//     for (let i = 0; i < segments; i++) {
//       const top1: number = startIndex + i * 2;
//       const bottom1: number = startIndex + i * 2 + 1;
//       const top2: number = startIndex + ((i + 1) % segments) * 2;
//       const bottom2: number = startIndex + ((i + 1) % segments) * 2 + 1;

//       // Corrected winding order for proper face orientation
...
//       const top1: number = startIndex + i * 2;
//       const top2: number = startIndex + ((i + 1) % segments) * 2;
//       Indices.push(topCenterIndex, top2, top1); // Corrected order
//     }
...
//       const bottom1: number = startIndex + i * 2 + 1;
//       const bottom2: number = startIndex + ((i + 1) % segments) * 2 + 1;
//       Indices.push(bottomCenterIndex, bottom1, bottom2); // Corrected order
//     }
